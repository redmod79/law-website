...
1. God spoke the Ten Commandments directly with His own voice (Exodus 20:1).
2. God wrote them with His own finger (Exodus 31:18).
3. They were written on stone (Deuteronomy 4:13).
4. They were placed inside the Ark of the Covenant (1 Kings 8:9).
5. After speaking them, God "added no more" (Deuteronomy 5:22).
6. They are called "his covenant" (Deuteronomy 4:13).
7. They are called "the testimony" (Exodus 31:18).
